...
export default class extends AbstractView {
  ...
  async getHtml() {
    ...
    // Pega o nome da unidade ativa (ou uma mensagem padrão se não existir)
    ...
    row += `
            <ul class="nav nav-tabs justify-content-center">
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="/awaiting/list">Confirmar Chegada</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/confirmationPhase/list">Confirmar Atendimentos</a>
                </li>
                <li class="nav-item">
