      ...
      },
      {
        ...
        value: function getMenu() {
          ...
          return regeneratorRuntime.async(
            function getMenu$(_context3) {
              while (1) {
                switch ((_context3.prev = _context3.next)) {
                  case 0:
                    row = "";
                    row +=
                      '\n            <ul class="nav nav-tabs justify-content-center">\n                <li class="nav-item">\n                    <a class="nav-link active" href="#">In\xEDcio</a>\n                </li>\n                <li class="nav-item">\n                    <a class="nav-link" href="/dataScheduling">Demandas</a>\n                </li>\n                <li class="nav-item">\n                    <a class="nav-link" href="/schedulingPhase">Agendamento</a>\n                </li>\n                <li class="nav-item">\n                    <a class="nav-link" href="/authorizationPhase/list">Aguardando Autoriza\xE7\xE3o</a>\n                </li>\n                ';
                    row += _get(
