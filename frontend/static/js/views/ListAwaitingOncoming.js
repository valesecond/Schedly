...
export default class extends AbstractView {
  ...
  constructor(params) {
    super(params);
    this.setTitle("Aguardando Chegada");
  ...
  async getMenu() {
    let row = `
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Aguardando Chegada</a>
        </li>
        <li class="nav-item">
  ...
  color: #198754 !important; /* ícone verde */
    ...
    <div class="container" id="container">
      <div class="main-card">
        ...
        <!-- Árvore de pessoas -->
        <div class="tree" id="personContainerConfirmation"></div>
      </div>
    </div>

    <img style="display:none" onload="showViewOncoming()" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==">
  `;
  }
}
