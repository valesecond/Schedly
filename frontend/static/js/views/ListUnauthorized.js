...
export default class extends AbstractView {
  ...
  constructor(params) {
    super(params);
    this.setTitle("Não Comparecidos");
  }
  ...
  async getMenu() {
    let row = `
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Não Comparecidos</a>
        </li>
      </ul>
    `;
    return row;
  ...
  @media (min-width: 768px) {
    ...
    <div class="container" id="container">
      <div class="main-card">
          ...
          <div class="filter-grid">
            ...
            <div class="text-end">
              <button
                ...
                onclick="UnauthorizedFilterAction()"
              >
        ...
        <!-- Árvore de pessoas -->
        <div class="tree" id="personUnauthorized"></div>
      </div>
    </div>

    <img style="display:none" onload="showViewUnauthorized()" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==">
  `;
  }
}
