  ...
  async getMenu() {
    let row = `
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/confirmationPhase/list">Aguardando Atendimento</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="#">Atendidos</a>
        </li>
      </ul>
    `;
    return row;
...
.specialist-item i {
  ...
  @media (min-width: 768px) {
    ...
    .form-control, .form-select { border-radius: .5rem; border: 1px solid #ced4da; padding: .55rem .75rem; font-size: .95rem; }
      .form-select:focus, .form-control:focus { box-shadow: 0 0 0 .2rem rgba(0,123,255,.25); border-color: #80bdff; }
  ...
  height: 32px;
  border-radius: 50%;
  background-color: #198754; /* verde padrão */
  border: none;
  padding: 0;
  display: flex;
  justify-content: center;
...
.btn-success.circle-btn i {
  color: white;
  font-size: 18px;
  transition: color 0.3s ease;
}

.btn-success.circle-btn:hover {
  background-color: transparent !important;
  border: 2px solid #198754 !important; /* borda verde */
}

.btn-success.circle-btn:hover i {
  color: #198754 !important; /* ícone verde */
}
    ...
    <div class="container" id="container">
      <div class="main-card">
        ...
        <div class="filter-container mb-4">
          <label for="unitFilter" class="form-label">Filtrar por unidade:</label>
        ...
        <!-- Árvore de pessoas -->
        <div class="tree" id="personContainerServed"></div>
      </div>
    </div>

    <img style="display:none" onload="showViewServed()" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==">
  `;
  }
}
