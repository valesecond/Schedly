  ...
  async getMenu() {
    return `
      <ul class="nav nav-tabs justify-content-center flex-wrap text-center">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Viagens Pendentes</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container py-3" style="max-width:1100px;">
          ...
          <div class="card-body p-3">
            <div class="row g-2 align-items-end">
              <div class="col-md-4">
                ...
                <select id="fltUnit" class="form-select">
              ...
              <div class="col-md-3">
                ...
                <select id="fltService" class="form-select">
        ...
        <div class="d-flex align-items-center justify-content-between mb-2">
          <div class="text-muted small">
            ...
            Mostrando <b id="countTravels">0</b> viagem(ns)
          </div>
        </div>

        <div id="travelList" class="row g-2"></div>
      </div>

      <img style="display:none" onload="openTravelPendings()" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" />
    `;
  }
}
