...
export default class extends AbstractView {
  ...
  constructor(params) {
    super(params);
    this.setTitle("Aguardando Autorização");
  }
  ...
  async getMenu() {
    let row = `
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Aguardando Autorização</a>
        </li>
        <li class="nav-item">
  ...
  @media (min-width: 768px) {
    ...
    <div class="container" id="container">
      <div class="main-card">
          ...
          <div class="filter-grid">
            ...
            <div class="text-end">
              <button
                ...
                onclick="authorizationFilterAction()"
              >
        ...
        <!-- Árvore de pessoas -->
        <div class="tree" id="personContainer"></div>
      </div>
    </div>

    <div id="pdfPreview"></div>

    <img style="display:none" onload="showViewAuthorization()" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==">
  `;
  }
}
